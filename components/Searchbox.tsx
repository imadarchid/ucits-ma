          ...
          {searchText.length ? (
            ...
            <div className="absolute min-w-full bg-white flex flex-col divide-x border-solid border-2 rounded-lg">
              {funds.data && funds.data?.map(x => (
                <div key={x.isin_code} className="min-w-full flex items-center shadow-sm px-4 py-2 hover:bg-slate-100 cursor-pointer" onClick={() => console.log(x.isin_code)}>
