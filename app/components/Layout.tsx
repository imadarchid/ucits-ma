              ...
              <div>
                <div>
                  ...
                  <p className="mt-6 md:text-lg text-gray-600 md:text-center">
                    Track your favorite OPCVM funds in Morocco. Get the right
                    data and make the right comparisons to make your investment
                    decision.
                  </p>
                </div>
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <stop offset="1" stopColor="#60FBCC" />
                      </linearGradient>
                    </defs>
                  </svg>
                </div>
